...
window.addEventListener('load', function () {
  ...
  $('#navigation-products-search-input, #navigation-products-search-input2').on(
    'focusin',
    function () {
  ...
  $(document).mouseup(function (e) {
    var container = $(
      '.search-results, #navigation-products-search-input, #navigation-products-search-input2'
    )
  ...
  $('#navigation-products-search-input, #navigation-products-search-input2')
    .parents('form')
...
function init() {
  ...
  $(document).on('click', '[data-toggle="custom-modal"]', function () {
    ...
    $(_target)
      .css('display', 'block')
      .after('<div class="custom-modal-backdrop"></div>')
  ...
  $('.custom-modal')
    ...
    .on('click', function () {
      ...
      $(this)
        .parents('.custom-modal')
        .css('display', '')
        .next('.custom-modal-backdrop')
        .remove()
    })
}
          ...
          .each(function (indx, el) {
            if ($(el)[0].checked) {
              ...
              data.push({
                name: name,
                value: value,
                name_attr: $radioinput.attr('name'),
              })
              return
            }
          })
  ...
  Navigation.prototype.initialize = function () {
    ...
    this._controls.$absolute = (
      settings.dotsContainer
        ? $(settings.dotsContainer)
        : $('<div>').addClass(settings.dotsClass).prependTo(this.$element)
    ).addClass('disabled')
...
window.addEventListener('load', function () {
  ...
  function header17Categories(categories) {
    ...
    categories.forEach(function (cat) {
      ...
      cat.products.forEach(function (product) {
        let url = Routing.generate('shop_simple_product', {
          slug: product.slug,
        })
    ...
    Object.values(categories).forEach(function (cat) {
      ...
      cat.categories.forEach(function (c) {
        ...
        c.products.forEach(function (product) {
          ...
          if (product.customizable == true)
            url = Routing.generate('shop_custom_product', {
              slug: product.slug,
            })
  ...
  function renderMobileCategories(categories) {
    ...
    m_sub_menu.append(
      '<li class="header hidden-md hidden-lg"><a href="#" class="back"></a></li>'
    )
    categories.forEach(function (cat) {
  ...
  function renderMainCategories(categories) {
    ...
    Object.values(categories).forEach(function (cat) {
      ...
      if (element.length > 0) element.after(li)
      else $('#menu-navbar-holder').prepend(li)
    })
  }
...
;('use strict')
WebFont.load({ google: { families: ['Cairo', 'Titan+One', 'Bebas+Neue'] } })
...
setTimeout(function () {
  $(window).scroll(function () {
    if ($(window).scrollTop() > $('nav').height()) {
      ...
      $('nav.navbar .navMenuCollapse').collapse({ toggle: false })
  ...
  if (logoImage.srcset === '/images/logo/602297ceef3a5.png')
    logoImage.alt = window.location.href.split('.')[0].split('//')[1]
}, 2)
